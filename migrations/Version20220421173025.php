 ...
 */
<<<<<<<< HEAD:migrations/Version20220421173319.php
final class Version20220421173319 extends AbstractMigration
========
final class Version20220421173025 extends AbstractMigration
>>>>>>>> 725b5a80560e235ed275ddfa244e541ee7e7552d:migrations/Version20220421173025.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demand (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, status_id INT NOT NULL, title VARCHAR(255) NOT NULL, subject VARCHAR(255) NOT NULL, publish_date DATETIME NOT NULL, comments VARCHAR(255) NOT NULL, INDEX IDX_428D797312469DE2 (category_id), INDEX IDX_428D79736BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
